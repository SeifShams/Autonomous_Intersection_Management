  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3072179432U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(232879568U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2157194216U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(786760126U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(instanceChksum, "s2Z7GOfWVlButVqSQtpw6EH") == 0) {
     ...
     case 3:
      {
        if (strcmp(instanceChksum, "s57fsu7ZvZkkT4CMzWrWYKG") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s2Z7GOfWVlButVqSQtpw6EH") == 0) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "s57fsu7ZvZkkT4CMzWrWYKG") == 0) {
